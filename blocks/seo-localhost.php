...
function checkCat($uri) {
    ...
    $pattern_cat = '#dongxe/[a-z0-9\-]+\-\d+.html#';
    ...
    $pattern_khuyenmai = '#khuyen-mai+.html#';
    $pattern_tvbh = '#tu-van-bao-hiem+.html#';
    $pattern_dklt = '#dang-ky-lai-thu+.html#';
    ...
    if (preg_match($pattern_khuyenmai, $uri)) {
        $mod = "khuyen-mai";
    }
    if (preg_match($pattern_tvbh, $uri)) {
        $mod = "tu-van-bao-hiem";
    }
    if (preg_match($pattern_dklt, $uri)) {
        $mod = "dang-ky-lai-thu";
    }
...
if ($tmp_uri[2] == 'khuyen-mai') {
    $com = "khuyen-mai";
}
if ($tmp_uri[2] == 'tu-van-bao-hiem') {
    $com = "tvbh";
}
if ($tmp_uri[2] == 'dang-ky-lai-thu') {
    $com = "dklt";
}
...
if ($tmp_uri[2] == 'dang-ky') {
    $com = "dang-ky";
}
if ($tmp_uri[1] == 'dang-ky-buoc-2') {
    $com = "dang-ky-b2";
}
if ($tmp_uri[2] == 'dang-nhap') {
    $com = "dang-nhap";
}
...
if ($tmp_uri[2] == 'tat-ca-nghanh') {
    $com = "all-cate";
}

if ($tmp_uri[2] == 'tin-tuc') {
    $com = "news";
}
...
switch ($com) {
    ...
    case "tvbh":       
        ...
        $metaD = "Tư vấn bảo hiểm";
        $metaK = "Tư vấn bảo hiểm";
        break;
    
    case "dklt":       
        $title = "Đăng ký lái thử ";        
        $metaD = "Đăng ký lái thử";
        $metaK = "Đăng ký lái thử";
        break;
    ...
    case "ctsp":
        ...
        $row_sp=  mysql_fetch_assoc($data);
	 $tieude=$row_sp['product_name_'.$lang];
    ...
    default :
         ...
         $title = "Mitsubishi ISAMCO";          
        $metaD = "Mitsubishi ISAMCO   ";
        $metaK = "Mitsubishi ISAMCO";
        break;
}
?>