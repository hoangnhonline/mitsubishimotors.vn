            ...
            <table>
                <thead>
                    ...
                    <tr>
                        ...
                        <?php /*<th width="20%" align="left">{tendailoan}</th>*/?>
                        <th width="20%" align="left">{tenvietnam}</th>
                        <?php /*<th width="20%" align="left">{tentienganh}</th>*/?>
                ...
                <tbody>
                    ...
                    while ($row = mysql_fetch_assoc($list_trang)) {
                        ...
                        <tr <?php if ($i % 2 == 0) echo "bgcolor='#CCC'"; ?>>
                           ...
                           <?php /* <td align="center" style="font-size: 16px;vertical-align: middle;"><?php echo $row['product_name_cn']; ?></td>*/?>
                            <td align="center" style="font-size: 16px;vertical-align: middle;"><?php echo $row['product_name_vi']; ?></td>
                            <?php /*<td align="center" style="font-size: 16px;vertical-align: middle;"><?php echo $row['product_name_en']; ?></td>*/?>
                            
                            <td align="center"><img src="../<?php echo $row['url_images']; ?>"  height="100"/></td>
