    ...
    <table>
      <tr class="left">
        ...
        <td><select name='parent_id' id="parent_id">
            ...
            <option <?php echo ($row['idTL']==$row_cha['idTL']) ? "selected" : ""; ?> value='<?php echo $row_cha['idTL'];?>'><?php echo $row_cha['TenTL_vi'];?></option>
            <?php } ?>            
          </select></td>
      </tr>
      <?php /*<tr class="left">
      ...
      <tr class="left">
        <td>{tenvietnam}</td>
        <td><input type="text" name="cate_name_en" id="cate_name_en" style="width:500px;height:25px" value="<?php echo $row['cate_name_vi']; ?>"  /></td>
      </tr> 
      <tr class="left">
        <td>&nbsp;</td>
        <td>
