<?php
    $sach = $modelCate->getAllTL();
?>
<script type="text/javascript">
    $(document).ready(function(){
        $(".linkxoatheloai").live('click',function(){			
            var flag = confirm("Bạn có chắc chắn xóa hãng xe này -> nếu xoá thì các dòng xe cũa hãng cũng sẽ xoá theo.");
            if(flag == true){
                var menu_id = $(this).attr("idTL");
                $.get('xoa.php',{loai:"theloai",id:menu_id},function(data){
...
<div>
    <div>
        ...
        <div style="width: 48%;float: left;text-align: right;padding-top: 20px;text-transform: uppercase;font-size: 15px;font-weight: bold"><a href="index.php?com=danhmuccha_add">Thêm hãng xe</a></div>
    </div>
                ...
                <tbody>
                    ...
                    while ($row = mysql_fetch_assoc($sach)) {	                        
                        ...
                        <tr id="rows_<?php echo $row['cate_id'];?>">
                            ...
                            <?php /*<td align="left" style="font-size: larger; font-weight: bold;"><?php echo $row['cate_name_cn'] ?></td>*/?>
                            <td align="left" style="font-size: larger; font-weight: bold;"><?php echo $row['TenTL_vi'] ?></td>
                            <?php /*<td align="left" style="font-size: larger; font-weight: bold;"><?php echo $row['cate_name_en'] ?></td>*/?>
                            <td class="action">                                  	
                                ...
                                <img class="linkxoatheloai" idTL="<?php echo $row['idTL'] ?>" src="img/icons/trash.png" alt="Xóa" title="Xóa" border="0">
                            </td>
                        </tr>
                        <?php 
                        $idTL = $row['idTL'];
                        ...
                        <tr id="rows_<?php echo $row_con['cate_id'];?>">
                            ...
                            <td align="center"><?php echo $i; ?></td>                                
                            <?php /*<td align="left" style="font-size: larger;">---- <?php echo $row_con['cate_name_cn'] ?></td> */?>
                            <td align="left">---- <?php echo $row_con['cate_name_vi'] ?></td> 
                            <?php /*<td align="left">---- <?php echo $row_con['cate_name_en'] ?></td> */?>
                            <td class="action">                                  	
