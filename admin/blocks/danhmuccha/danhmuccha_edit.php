...
<form action="" method="post" name="form_add_dm_ks">
  ...
  <div id="main_left">
    <table>
      ...
      <?php /*<tr class="left">
        <td>{tendailoan}</td>
        <td><input type="text" name="tl_name_cn" id="tl_name_cn" style="width:500px;height:25px" value="<?php echo $row['cate_name_cn']; ?>"  /></td>
      </tr>*/?>
      <tr class="left">
        <td>{tenvietnam}</td>
      ...
      <?php /*<tr class="left">
        <td>{tentienganh}</td>
        <td><input type="text" name="tl_name_en" id="tl_name_en" style="width:500px;height:25px" value="<?php echo $row['cate_name_en']; ?>"  /></td>
      </tr>*/?>
      <tr class="left">
        <td>&nbsp;</td>
        <td>
