...
class Article extends Db {
    ...
    function insertArticle() {
        ...
        $sql = "INSERT INTO article	VALUES(NULL,'$title_cn','$title_vi','$title_en','$title_alias','$content_cn','$content_vi','$content_en',
    ...
    function updateArticle($article_id) {
        ...
        $sql = "UPDATE article
					SET title_cn = '$title_cn',title_vi = '$title_vi',title_en = '$title_en',title_alias = '$title_alias',
					content_cn = '$content_cn',content_vi = '$content_vi',content_en = '$content_en',HinhDaiDien = '$HinhDaiDien'					
